...
function HomeComponent_li_11_Template(rf, ctx) { if (rf & 1) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "li", 12);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_li_11_Template_li_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const region_r2 = ctx.$implicit; const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.onSelectRegion(region_r2); });
...
function HomeComponent_a_14_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("routerLink", "/country/", country_r5.id, "");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("lazyLoad", country_r5.flag)("defaultImage", ctx_r1.defaultImage)("alt", country_r5.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](country_r5.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](country_r5.population.toLocaleString());
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](country_r5.region);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](5);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](country_r5.capital);
} }
...
class HomeComponent {
    constructor(store) {
        ...
        this.defaultImage = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkqAcAAIUAgUW0RjgAAAAASUVORK5CYII=";
    }
    ngOnInit() {
        this.countries$ = this.store.select(src_app_states_country_selectors__WEBPACK_IMPORTED_MODULE_2__["selectCountries"]);
        this.regions$ = this.store.select(src_app_states_country_selectors__WEBPACK_IMPORTED_MODULE_2__["selectRegions"]);
    }
    onInput(query) {
        if (this.timeid)
        ...
        this.timeid = window.setTimeout(() => {
            ...
            this.countries$ = this.countries$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((countries) => countries.filter(c => new RegExp(this.name, "gi").test(c.name) && new RegExp(region, "gi").test(c.region))));
        }, 100);
    }
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 16, vars: 11, consts: [[1, "search-form"], [1, "search-wrap"], [1, "fas", "fa-search"], ["type", "text", "placeholder", "Search for a country...", 1, "search-input", "hasShadow", 3, "ngModel", "ngModelChange"], [1, "search-filter"], [1, "drop-btn", "hasShadow", "search-input", 3, "click"], [1, "fa-angle-down"], [1, "dropdown", "hasShadow", 3, "ngClass"], [1, "menu-bar"], ["class", "region", 3, "click", 4, "ngFor", "ngForOf"], [1, "country-list"], ["class", "country", 3, "routerLink", 4, "ngFor", "ngForOf"], [1, "region", 3, "click"], [1, "country", 3, "routerLink"], [1, "country-flag"], ["width", "450", "height", "300", 3, "lazyLoad", "defaultImage", "alt"], [1, "description"], [1, "name", "title"], [1, "population", "desc"], [1, "right"], [1, "region", "desc"], [1, "capital", "desc"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](2, "i", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "input", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_3_listener($event) { return ctx.name = $event; })("ngModelChange", function HomeComponent_Template_input_ngModelChange_3_listener($event) { return ctx.onInput($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "div", 4);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "div", 5);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_Template_div_click_5_listener() { return ctx.dropdownShow = !ctx.dropdownShow; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](11, HomeComponent_li_11_Template, 3, 1, "li", 9);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, HomeComponent_a_14_Template, 21, 8, "a", 11);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](9, _c0, ctx.dropdownShow));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](12, 5, ctx.regions$));
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](15, 7, ctx.countries$));
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"], ng_lazyload_image__WEBPACK_IMPORTED_MODULE_7__["LazyLoadImageDirective"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["AsyncPipe"]], styles: [".search-form[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n}\n.search-form[_ngcontent-%COMP%]   .search-wrap[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  position: absolute;\n  line-height: 2.6rem;\n  margin-left: 1rem;\n}\n.search-form[_ngcontent-%COMP%]   .search-wrap[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  width: 300px;\n  color: var(--text-color);\n}\n.search-form[_ngcontent-%COMP%]   .search-wrap[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::placeholder {\n  opacity: 0.5;\n  \n}\n.search-form[_ngcontent-%COMP%]   .search-wrap[_ngcontent-%COMP%]   [_ngcontent-%COMP%]:-ms-input-placeholder {\n  \n  opacity: 0.5;\n}\n.search-form[_ngcontent-%COMP%]   .search-wrap[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-ms-input-placeholder {\n  \n  opacity: 0.5;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%] {\n  position: relative;\n  font-weight: 600;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .drop-btn[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 200px;\n  font-size: 0.9rem;\n  padding: 0.375rem 0.75rem;\n  cursor: pointer;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .drop-btn.disabled[_ngcontent-%COMP%] {\n  cursor: default;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .dropdown[_ngcontent-%COMP%] {\n  z-index: 100;\n  position: absolute;\n  top: 3rem;\n  width: 200px;\n  overflow: hidden;\n  border-radius: 0.25rem;\n  background: var(--header-bg-color);\n  display: none;\n  transition: all 0.3s ease;\n  box-sizing: border-box;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .dropdown.show[_ngcontent-%COMP%] {\n  display: block;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .dropdown[_ngcontent-%COMP%]   ul[_ngcontent-%COMP%] {\n  width: 100%;\n  list-style: none;\n  padding: 10px;\n  box-sizing: border-box;\n  margin: 0;\n  transition: all 0.3s ease;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .dropdown[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  line-height: 1.6em;\n}\n.search-form[_ngcontent-%COMP%]   .search-filter[_ngcontent-%COMP%]   .dropdown[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  position: relative;\n  color: var(--text-color);\n  padding: 0 10px;\n  cursor: pointer;\n}\n.search-form[_ngcontent-%COMP%]   .search-input[_ngcontent-%COMP%] {\n  outline: none;\n  height: 2.8rem;\n  padding: 0.375rem 0.75rem 0.375rem 2.5rem;\n  font-size: 1rem;\n  background-clip: padding-box;\n  border: none;\n  border-radius: 0.25rem;\n  background: var(--header-bg-color);\n  box-sizing: border-box;\n}\n.country-list[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-column-gap: 5.5%;\n  grid-row-gap: 2rem;\n  margin-top: 2rem;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%] {\n  box-shadow: 0px 2px 5px 1px rgba(0, 0, 0, 0.2);\n  cursor: pointer;\n  border-radius: 0.3rem;\n  overflow: hidden;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%]   .country-flag[_ngcontent-%COMP%] {\n  overflow: hidden;\n  height: 0;\n  padding-top: 66%;\n  position: relative;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%]   .country-flag[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 100%;\n  position: absolute;\n  top: 0;\n  left: 0;\n  height: 100%;\n  object-fit: cover;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%] {\n  padding: 1.5rem;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%]   .name.title[_ngcontent-%COMP%] {\n  font-size: 1.2em;\n  font-weight: bold;\n  margin-bottom: 0.5rem;\n}\n.country-list[_ngcontent-%COMP%]   .country[_ngcontent-%COMP%]   .description[_ngcontent-%COMP%]   .desc[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-weight: 600;\n}\n@media (max-width: 1049px) {\n  .country-list[_ngcontent-%COMP%] {\n    grid-template-columns: repeat(3, 1fr);\n  }\n}\n@media (max-width: 768px) {\n  .country-list[_ngcontent-%COMP%] {\n    grid-template-columns: repeat(2, 1fr);\n  }\n}\n@media (max-width: 580px) {\n  .search-form[_ngcontent-%COMP%] {\n    flex-direction: column;\n    row-gap: 2rem;\n  }\n\n  .country-list[_ngcontent-%COMP%] {\n    grid-template-columns: repeat(1, 1fr);\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](HomeModule, { declarations: [_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
        ng_lazyload_image__WEBPACK_IMPORTED_MODULE_5__["LazyLoadImageModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"]] }); })();
